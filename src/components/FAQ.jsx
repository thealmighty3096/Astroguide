          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-8 md:py-12 px-4 md:px-0">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white">Marriage Compatibility</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white">Life Purpose Reading</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white">Business Consultation</a></li>
              </ul>
            </div>
